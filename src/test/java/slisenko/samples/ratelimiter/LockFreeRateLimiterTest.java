...
public class LockFreeRateLimiterTest {

    @Test
    public void testSingleThread_SingleUser() {
        // Given rate limiter and single user
        IRateLimiter rl = new LockFreeRateLimiter(2, Duration.ofMinutes(1));
        String userId = "1";
    ...
    void testMultipleThreads_SingleUser() throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            // Given rate limiter and single user
            IRateLimiter rl = new LockFreeRateLimiter(1, Duration.ofMinutes(1));
            String user1 = "1";
    ...
    public void testTimeWindowExpiration() {
        // Given rate limiter and single user
        LockFreeRateLimiter rl = spy(new LockFreeRateLimiter(2, Duration.ofMinutes(1)));
        String userID = "1";
